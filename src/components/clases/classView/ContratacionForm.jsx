...
export function ContratacionForm(props) {
  ...
  const formValidation = Yup.object().shape({
    ...
    from: Yup.date().max(Yup.ref("to"), "Debe ser menor que Hasta").required("Campo requerido"),
    to: Yup.date().min(Yup.ref("from"), "Debe ser mayor que Desde").required("Campo requerido"),
